...
export function AwsChip({
  ...
  return (
    ...
    >
      <span
        className="relative inline-flex h-11 w-11 items-center justify-center rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--bg))] text-[11px] font-bold tracking-tight"
        style={{
